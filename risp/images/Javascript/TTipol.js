...
//	return;
         ...
         if ( lastElement != targetElement )
         {
            ...
            if ( '' != descValue )
            {
               ...
               var ImgName = "../helpers/getcustimage.aspx?ID=" + descValue.substring(5) + "&IMGNO=1"
	...
	{	
		...
		if (evt.button == 2)
		{
			...
			if (nt) {
				...
				{
				MenuItems.item(0).firstChild.nodeValue = 'More Details';
		...
		if (nt) {
			...
			switch (MnuTxt)
				...
				case 'Center':
					...
					fobj.setAttributeNS(null,'visibility','hidden');
					var newurl = 'GETDET.ASPX?SP=FLINTSGENXMLPACKAGE.GET_GEN_XML&ID=' + nr.firstChild.nodeValue + '&P_SOURCE=FLINTSGRAPHIC&P_FORCE=20';
